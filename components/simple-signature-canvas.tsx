...
export default function SimpleSignatureCanvas({ 
  ...
  useEffect(() => {
    console.log("useEffect triggered - isOpen:", isOpen, "canvas exists:", !!canvasRef.current)
    
    if (isOpen) {
      // Use a timeout to ensure the canvas is fully rendered
      const timer = setTimeout(() => {
        const canvas = canvasRef.current
        console.log("After timeout - canvas exists:", !!canvas)
        ...
        if (canvas) {
          ...
          if (ctx) {
            ...
            console.log("✅ Canvas configured with blue color:", ctx.strokeStyle)
          }
        }
